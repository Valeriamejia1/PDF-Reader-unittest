...
class TestExcel(unittest.TestCase):
    ...
    def test_API_1(self):
        ...
        data_frame = pd.read_excel("TestCases API\TMMC W.E. 4.22.xlsx", sheet_name="OutputData")
    ...
    def test_API_2(self):
        ...
        data_frame = pd.read_excel("TestCases API\Delta Health 4.15.23.xlsx", sheet_name="OutputData")
    ...
    #File: Hannibal
        ...
        # Upload Excel file
        excel_file = 'TestCases API\Hannibal 4.15.23 SCHED.xlsx'
    ...
    def test_API_7(self):
        ...
        #File: DELTA modified
        data_frame = pd.read_excel("TestCases API\Delta Health 4.15.23 SCHED.xlsx", sheet_name="OutputData")
    ...
    def test_API_9(self):
        ...
        # Upload Excel file
        df = pd.read_excel("TestCases API\TMMC W.E. 4.22 SCHED.xlsx", sheet_name="OutputData")
    ...
    def test_API_10(self):
        ...
        # Upload Excel file
        df_output = pd.read_excel("TestCases API\TMMC W.E. 4.22 SCHED.xlsx", sheet_name="OutputData")
        df_raw = pd.read_excel("TestCases API\TMMC W.E. 4.22 SCHED.xlsx", sheet_name="RawData")
