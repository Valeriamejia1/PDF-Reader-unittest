...
class ExcelTest(unittest.TestCase):
    ...
    def test_UKGC_3_1(self):
        self.compare_excel_files("TestCasesUKGCommon/Martin ppe 4.22.23 ORIG.xlsx", "QA/Output Files/OUTPUT UKGCommon/Martin ppe 4.22.23.xlsx")
        print("TEST 3.1 UKGCommon CORRECT: Martin ppe 4.22.23.xlsx data match the original version")


    def test_UKGC_3_2(self):
        self.compare_excel_files("TestCasesUKGCommon/martin time a ORIG.xlsx", "QA/Output Files/OUTPUT UKGCommon/martin time a.xlsx")
    ...
    def test_UKGC_6_1(self):
        self.compare_excel_files("TestCasesUKGCommon/martin b ORIG.xlsx", "QA/Output Files/OUTPUT UKGCommon/martin b.xlsx")
        print("TEST 6.1 UKGCommon CORRECT: martin b ORIG.xlsx data match the original version")

    def test_UKGC_6_2(self):
        self.compare_excel_files("TestCasesUKGCommon/Martin Holiday Shifts 7.3 to 7.5.23 ORIG.xlsx", "QA/Output Files/OUTPUT UKGCommon/Martin Holiday Shifts 7.3 to 7.5.23.xlsx")
