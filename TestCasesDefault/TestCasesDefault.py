...
class ExcelTestCase(unittest.TestCase):
    ...
    def test_DEFAULT_10(self):
        ...
        file_data = [
            {'file_path': 'TestCasesDefault/Scripps Approved Kronos we 6.25.22 minutes.xlsx', 'sheet_name': 'Sheet1'},
            {'file_path': 'TestCasesDefault/Scripps Approved Kronos we 6.25.22.xlsx', 'sheet_name': 'Sheet1'}
        ]
    ...
    def test_DEFAULT_13(self):
        ...
        # List of file paths and sheet names to validate
        file_data = [
            {'file_path': 'TestCasesDefault/6-11.xlsx', 'sheet_name': 'Sheet1'},
            {'file_path': 'TestCasesDefault/6-11 Minutes.xlsx', 'sheet_name': 'Sheet1'}
        ]
